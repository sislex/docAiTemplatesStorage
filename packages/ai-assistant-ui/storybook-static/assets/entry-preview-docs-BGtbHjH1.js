import { _ as nt, a as Z, c as Mr, d as gi, b as yn } from './chunk-XP5HYGXS-BHXC9YeQ.js';
import {
  c as Di,
  n as Ai,
  y as Ci,
  ...
  a as Dt,
  Y as Ur,
} from './index-DgH-xKnr.js';
import { r as Ge, R as ft } from './index-C5e9SFkp.js';
      ...
      (function t(r) {
        ...
        ((C.prototype.traverse = function (x, y) {
          ...
          for (
            ...
            if (P.node) {
              ...
              if ((v.push($), B.push(P), this.__state === h || V === h)) continue;
              ...
              for (Q = se.length; (Q -= 1) >= 0; )
                if (((U = se[Q]), (ue = j[U]), !!ue)) {
                  if (Array.isArray(ue)) {
                    for (ne = ue.length; (ne -= 1) >= 0; )
                      if (ue[ne] && !w(B, ue[ne])) {
                        if (E(M, se[Q])) P = new A(ue[ne], [U, ne], 'Property', null);
          ...
          (C.prototype.replace = function (x, y) {
            var v, B, P, j, M, V, U, Q, ne, se, ue, $, we;
            function st(Re) {
              var R, Xe, je, ut;
              if (Re.ref.remove()) {
                for (Xe = Re.ref.key, ut = Re.ref.parent, R = v.length; R--; )
                  if (((je = v[R]), je.ref && je.ref.parent === ut)) {
                    if (je.ref.key < Xe) break;
                    --je.ref.key;
                  }
              }
            }
            for (
              this.__initialize(x, y),
                ...
                B = this.__leavelist,
                $ = { root: x },
                V = new A(x, null, null, new F($, 'root')),
                v.push(V),
                B.push(V);
              v.length;
            ) {
                ...
                for (U = ne.length; (U -= 1) >= 0; )
                  if (((we = ne[U]), (se = P[we]), !!se))
                    if (Array.isArray(se)) {
                      for (Q = se.length; (Q -= 1) >= 0; )
                        if (se[Q]) {
                          if (E(j, ne[U])) V = new A(se[Q], [we, Q], 'Property', new F(se, Q));
                          else if (D(se[Q])) V = new A(se[Q], [we, Q], null, new F(se, Q));
                          else continue;
                          v.push(V);
                        }
        ...
        function _(x, y, v) {
          ...
          return (
            ...
            b(x, {
              enter: function (U) {
                for (var Q; V < B.length && ((Q = B[V]), !(Q.extendedRange[1] > U.range[0])); )
                  Q.extendedRange[1] === U.range[0]
                    ? (U.leadingComments || (U.leadingComments = []),
                      U.leadingComments.push(Q),
                      B.splice(V, 1))
                    : (V += 1);
            ...
            b(x, {
              leave: function (U) {
                for (var Q; V < B.length && ((Q = B[V]), !(U.range[1] < Q.extendedRange[0])); )
                  U.range[1] === Q.extendedRange[0]
                    ? (U.trailingComments || (U.trailingComments = []),
                      U.trailingComments.push(Q),
                      B.splice(V, 1))
                    : (V += 1);
                if (V === B.length) return s.Break;
                if (B[V].extendedRange[0] > U.range[1]) return s.Skip;
          ...
          p.eachMapping(function (S) {
            if (w !== null)
              if (D < S.generatedLine) (b(w, C()), D++, (E = 0));
                ...
                ((F[A] = L.substr(S.generatedColumn - E)),
                  (E = S.generatedColumn),
                  b(w, _),
                  (w = S));
                return;
...
`,
        ...
        function pi(i, l) {
          ...
          for (
            ...
            ((X = K(fe(a[c].slice(T)))), (a[c] = y ? X.join('') : X));
          return (
            (h = O),
            a.join(`
`)
...
`),
        ...
        function Nr(i, l) {
          var a, c, d, k, I, T, O, X, ce, Ve, Qe, Rr, jr, ve;
...
` && (d = ['{']),
                      d.push(c)));
                  var I, T, O, X;
                  for (X = re, l & se && (X |= ue), I = 0, T = i.body.length; I < T; ++I)
                    (B &&
                      (I === 0 &&
                        (i.body[0].leadingComments &&
                          ...
                          c[0] ===
                            `
` && (d = ['{'])),
                        i.body[0].leadingComments || He(i.range[0], i.body[0].range[0], d)),
                      I > 0 &&
                        !i.body[I - 1].trailingComments &&
                        !i.body[I].leadingComments &&
                        He(i.body[I - 1].range[1], i.body[I].range[0], d)),
                      I === T - 1 && (X |= $),
                      i.body[I].leadingComments && B
                        ? (O = k.generateStatement(i.body[I], X))
                        : (O = fe(k.generateStatement(i.body[I], X))),
                      d.push(O),
                      he(K(O).toString()) ||
                      ...
                      B &&
                        I === T - 1 &&
                        (i.body[I].trailingComments || He(i.body[I].range[1], i.range[1], d)));
                }),
                d.push(fe('}')),
                d
              );
            ...
            ExpressionStatement: function (i, l) {
              ...
              function I(T) {
                ...
                for (X = 6, ce = T.length; X < ce && u.code.isWhiteSpace(T.charCodeAt(X)); ++X);
                return X === ce || T.slice(X, X + 8) !== 'function'
                  ? !1
                  : ((O = T.charCodeAt(X + 8)),
                    O === 40 || u.code.isWhiteSpace(O) || O === 42 || u.code.isLineTerminator(O));
              }
...
`),
                ...
                ae(function () {
                  for (
                    ...
                    (d === k - 1 && l & $ && (I |= $),
                      ...
                      a.push(c),
                      d + 1 !== k && !he(K(c).toString()) && a.push(D));
                }),
                a
              );
            },
            ...
            ForStatement: function (i, l) {
              ...
              return (
                ...
                a.push(this.maybeBlock(i.body, l & $ ? xe : re)),
                a
              );
            },
            ForInStatement: function (i, l) {
              return this.generateIterationForStatement('in', i, l & $ ? xe : re);
            },
            ForOfStatement: function (i, l) {
              return this.generateIterationForStatement('of', i, l & $ ? xe : re);
            },
            LabeledStatement: function (i, l) {
              return [i.label.name + ':', this.maybeBlock(i.body, l & $ ? xe : re)];
            },
...
`
                ...
                (!S && d === k - 1 && (I |= $),
                  B &&
                    (d === 0 &&
                      (i.body[0].leadingComments || He(i.range[0], i.body[d].range[0], a)),
                    d > 0 &&
                      !i.body[d - 1].trailingComments &&
                      !i.body[d].leadingComments &&
                      He(i.body[d - 1].range[1], i.body[d].range[0], a)),
                  ...
                  B &&
                    d === k - 1 &&
                    (i.body[d].trailingComments || He(i.body[d].range[1], i.range[1], a)));
              return a;
            },
          ...
          (oe.Expression = {
            ...
            CallExpression: function (i, l, a) {
              ...
              for (
                ...
                (c.push(this.generateExpression(i.arguments[d], r.Assignment, R)),
                  d + 1 < k && c.push(',' + E));
              return (c.push(')'), a & Q ? le(c, r.Call, l) : ['(', c, ')']);
            },
            ChainExpression: function (i, l, a) {
              r.OptionalChaining < l && (a |= Q);
            ...
            MemberExpression: function (i, l, a) {
              var c, d;
              return (
                (c = [this.generateExpression(i.object, r.Call, a & Q ? Re : Xe)]),
                i.computed
                  ? (i.optional && c.push('?.'),
                    c.push('['),
                    c.push(this.generateExpression(i.property, r.Sequence, a & Q ? R : ut)),
                    c.push(']'))
                  : (!i.optional &&
            ...
            ArrayExpression: function (i, l, a, c) {
              ...
              return i.elements.length
                ? ((k = c ? !1 : i.elements.length > 1),
                  ...
                  ae(function (T) {
                    var O, X;
                    for (O = 0, X = i.elements.length; O < X; ++O)
                      (i.elements[O]
                        ? (d.push(k ? T : ''),
                          d.push(I.generateExpression(i.elements[O], r.Assignment, R)))
                        : (k && d.push(T), O + 1 === X && d.push(',')),
                        O + 1 < X && d.push(',' + (k ? D : E)));
                  }),
                  k && !he(K(d).toString()) && d.push(D),
                  d.push(k ? h : ''),
                  d.push(']'),
                  d)
                : '[]';
                ...
                ? ((c = i.properties.length > 1),
                  ...
                  !c && !ii(K(k).toString())
                    ...
                    : (ae(function (T) {
                        var O, X;
                        if (((d = ['{', D, T, k]), c))
                          for (d.push(',' + D), O = 1, X = i.properties.length; O < X; ++O)
                            (d.push(T),
                              d.push(I.generateExpression(i.properties[O], r.Sequence, R)),
                              O + 1 < X && d.push(',' + D));
                      }),
                      he(K(d).toString()) || d.push(D),
                      d.push(h),
                      d.push('}'),
                      d))
                : '{}';
          ...
          (oe.prototype.generateExpression = function (i, l, a) {
            ...
            return (
              ...
              _.verbatim && i.hasOwnProperty(_.verbatim)
                ? fi(i, l)
                : ((c = this[d](i, l, a)), _.comment && (c = Nr(i, c)), K(c, i))
            );
          }),
            ...
            return (
              ...
              i.type === t.Program &&
                ...
                c.charAt(c.length - 1) ===
                  `
` &&
                (a = y ? K(a).replaceRight(/\s+$/, '') : c.replace(/\s+$/, '')),
              K(a, i)
            );
          }));
        function di(i) {
...
function H(e, t) {
  return (t === void 0 && (t = {}), (t.keyword = e), (dt[e] = new Y(e, t)));
}
function Ze(e, t) {
  ...
  gr = gi({
    '../../node_modules/acorn/dist/acorn.mjs'() {
      ((bt = {
        ...
        (f = {
          num: new Y('num', ge),
          regexp: new Y('regexp', ge),
          string: new Y('string', ge),
          name: new Y('name', ge),
          eof: new Y('eof'),
          ...
          _default: H('default', Ce),
          _do: H('do', { isLoop: !0, beforeExpr: !0 }),
          _else: H('else', Ce),
          _finally: H('finally'),
          _for: H('for', { isLoop: !0 }),
          _function: H('function', ge),
          _if: H('if'),
          _return: H('return', Ce),
          _switch: H('switch'),
          _throw: H('throw', Ce),
        ...
        (te = function (e, t, r) {
          ((this.options = e = zi(e)),
            ...
            (this.keywords = We(
              Qr[e.ecmaVersion >= 6 ? 6 : e.sourceType === 'module' ? '5module' : 5],
            )));
          var n = '';
...
`,
        ...
        (Ne.allowDirectSuper.get = function () {
          return (this.currentThisScope().flags & Ht) > 0;
        }),
        ...
        (z.parseFunctionStatement = function (e, t, r) {
          return (this.next(), this.parseFunction(e, Ke | (r ? 0 : Pt), !1, t));
        }),
        ...
        (z.parseTryStatement = function (e) {
          if (
            ...
            if ((this.next(), this.eat(f.parenL))) {
              ...
              (this.enterScope(r ? Jt : 0),
                this.checkLVal(t.param, r ? Kt : _e),
        ...
        (z.parseFunction = function (e, t, r, n) {
          (this.initFunction(e),
            ...
            t & Ke &&
              ((e.id = t & $t && this.type !== f.name ? null : this.parseIdent()),
              e.id &&
                !(t & Pt) &&
                this.checkLVal(
                  e.id,
                  this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? It : _e) : Yt,
                )));
          var s = this.yieldPos,
            o = this.awaitPos,
          ...
          return (
            ...
            t & Ke || (e.id = this.type === f.name ? this.parseIdent() : null),
            this.parseFunctionParams(e),
            this.parseFunctionBody(e, r, !1),
            (this.yieldPos = s),
            (this.awaitPos = o),
            (this.awaitIdentPos = u),
            this.finishNode(e, t & Ke ? 'FunctionDeclaration' : 'FunctionExpression')
          );
        }),
        ...
        (z.parseExport = function (e, t) {
          ...
          if (this.eat(f._default)) {
            ...
            if (this.type === f._function || (r = this.isAsyncFunction())) {
              ...
              (this.next(),
                r && this.next(),
                (e.declaration = this.parseFunction(n, Ke | $t, !1, r)));
            ...
            case 'Identifier':
              (t === _e &&
                ...
                r &&
                  ...
                  (r[e.name] = !0)),
                t !== Qt && t !== Zt && this.declareName(e.name, t, e.start));
              break;
            case 'ChainExpression':
              this.raiseRecoverable(e.start, 'Optional chaining cannot appear in left-hand side');
              break;
        ...
        (G.checkPropClash = function (e, t, r) {
          if (
            ...
            if (u) {
              var h;
              (o === 'init'
                ? (h = (this.strict && u.init) || u.get || u.set)
                : (h = u.init || u[o]),
...
`,
        ...
        (G.parseMethod = function (e, t, r) {
          ...
          return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(Vt(t, n.generator) | Xt | (r ? Ht : 0)),
            this.expect(f.parenL),
        ...
        (G.parseFunctionBody = function (e, t, r) {
          ...
          if (n) ((e.body = this.parseMaybeAssign()), (e.expression = !0), this.checkParams(e, !1));
            ...
            ((this.labels = []),
              ...
              this.strict && e.id && this.checkLVal(e.id, Zt),
        ...
        (Ie.treatFunctionsAsVarInScope = function (e) {
          return e.flags & $e || (!this.inModule && e.flags & Ye);
        }),
        (Ie.declareName = function (e, t, r) {
          ...
          if (t === _e) {
            ...
            ((n =
              s.lexical.indexOf(e) > -1 || s.functions.indexOf(e) > -1 || s.var.indexOf(e) > -1),
              s.lexical.push(e),
              this.inModule && s.flags & Ye && delete this.undefinedExports[e]);
          } else if (t === Kt) {
            ...
            for (var h = this.scopeStack.length - 1; h >= 0; --h) {
              ...
              if (
                (p.lexical.indexOf(e) > -1 && !(p.flags & Jt && p.lexical[0] === e)) ||
              ...
              if (
                (p.var.push(e),
                this.inModule && p.flags & Ye && delete this.undefinedExports[e],
                p.flags & kt)
              )
                break;
            }
        ...
        (q.regexp_eatBracedQuantifier = function (e, t) {
          ...
          if (e.eat(123)) {
            ...
            if (
              ...
              return (
                s !== -1 && s < n && !t && e.raise('numbers out of order in {} quantifier'),
                !0
              );
        ...
        (q.regexp_eatRegExpIdentifierPart = function (e) {
          ...
          return (
            e.advance(r),
            n === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, r) && (n = e.lastIntValue),
            Xi(n) ? ((e.lastIntValue = n), !0) : ((e.pos = t), !1)
          );
        }),
        ...
        (q.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
          ...
          if (e.eat(117)) {
            ...
            if (n && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && Hi(e.lastIntValue))
              return !0;
        ...
        (q.regexp_eatCharacterClassEscape = function (e) {
          var t = e.current();
          if (Qi(t)) return ((e.lastIntValue = -1), e.advance(), !0);
        ...
        (q.regexp_eatClassAtom = function (e) {
          ...
          if (e.eat(92)) {
            ...
            if (e.switchU) {
              var r = e.current();
              ((r === 99 || Xr(r)) && e.raise('Invalid class escape'), e.raise('Invalid escape'));
            }
            e.pos = t;
          }
          var n = e.current();
        ...
        (q.regexp_eatOctalDigit = function (e) {
          var t = e.current();
          return Xr(t) ? ((e.lastIntValue = t - 48), e.advance(), !0) : ((e.lastIntValue = 0), !1);
        }),
        (q.regexp_eatFixedHexDigits = function (e, t) {
          ...
          for (var n = 0; n < t; ++n) {
            ...
            ((e.lastIntValue = 16 * e.lastIntValue + Jr(s)), e.advance());
          }
          return !0;
        }),
        (pt = function (e) {
        ...
        (J.skipLineComment = function (e) {
          for (
            ...
            this.pos < this.input.length && !Ze(n);
          )
        ...
        (J.readRadixNumber = function (e) {
          ...
          return (
            ...
            this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
              ? ((r = Hr(this.input.slice(t, this.pos))), ++this.pos)
        ...
        (J.readNumber = function (e) {
          ...
          if (!r && !e && this.options.ecmaVersion >= 11 && n === 110) {
            var s = Hr(this.input.slice(t, this.pos));
            return (
              ++this.pos,
              Te(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, 'Identifier directly after number'),
          ...
          (r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
            ...
            Te(this.fullCharCodeAtPos()) &&
              this.raise(this.pos, 'Identifier directly after number'));
          var o = Ki(this.input.slice(t, this.pos), r);
          ...
          for (var t = '', r = ++this.pos; ; ) {
            ...
            n === 92
              ? ((t += this.input.slice(r, this.pos)),
                ...
                (r = this.pos))
              : (Ze(n, this.options.ecmaVersion >= 10) &&
          ...
          var E =
            ...
            w
              .map(function (S, L) {
                ...
                return (
                  A.transform && (B = A.transform(p, S, B)),
                  C.indent + String(v) + ': ' + B + _
                );
              })
              .join('') +
            C.pad +
...
N.BreakStatement = N.ContinueStatement = Je;
...
N.Expression = Sr;
N.ThisExpression = N.Super = N.MetaProperty = Je;
...
`.concat(Pe(r + 1, n.tabStop), '$1'),
  ...
  Zs = function (e, t, r, n) {
    ...
    if (typeof e == 'string') return '"'.concat(Ks(e), '"');
    if (gt(e) === 'symbol') {
      var s = e
        .valueOf()
        .toString()
  ...
  Xn = function (e, t, r, n) {
    ...
    if (
      (v.forEach(function (P) {
        var j = $s(P, Object.keys(m).includes(P), m[P], Object.keys(F).includes(P), F[P], t, r, n),
...
`),
  ...
  pu = function (e, t, r, n) {
    ...
    var h = n.useFragmentShortSyntax,
      p;
    return (h ? (hu(e) || cu(e) ? (p = dn) : (p = ou)) : (p = dn), Xn(lu(p, o, u), t, r, n));
  },
  fu = ['<', '>', '{', '}'],
  du = function (e) {
  ...
  Mt = function (e, t, r, n) {
    ...
    if (e.type === 'ReactElement') return Xn(e, t, r, n);
...
var Eu = (e) => {
    if (Qn(e) && e.type != null) return Cu(e);
    if (Ts(e)) {
  ...
  Fu = (e) => ee(e.toString()),
  Kn = { string: Au, object: Eu, function: yu, default: Fu };
function xu(e = {}) {
  return { ...Kn, ...e };
}
function vu(e, t, r = Kn) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t);
...
function ku({ raw: e }) {
  return e != null ? $n(e, 'custom') : me({ name: 'custom', short: Dr, compact: Dr });
}
function Iu(e) {
  let { jsDocTags: t } = e;
...
function Lu({ value: e, computed: t }) {
  return t ? $n(e, 'enumvalue') : me({ name: 'enumvalue', short: e, compact: e });
}
function Ou(e) {
  if (Array.isArray(e.value)) {
...
var Xu = (e) => ({ rows: Ju(e, 'props') }),
  ...
  ur = Hn,
  Qu = (e) => e.charAt(0).toUpperCase() + e.slice(1),
  Yu = (e) =>
    (e.$$typeof || e)
      .toString()
      .replace(/^Symbol\((.*)\)$/, '$1')
      .split('.')
      .map((t) => t.split('_').map(Qu).join(''))
      .join('.');
function Fr(e) {
...
`,
  ...
  Zu = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  $u = (e) => {
    var n;
  ...
  ti = (e, t) => {
    ...
    let o = e();
    if (n) return o;
    let u = { ...Zu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      h =
  ...
  ra = { docs: { story: { inline: !0 }, extractArgTypes: Hu, extractComponentDescription: Ai } },
  na = [ti],
  ia = [Di];
