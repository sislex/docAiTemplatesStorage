...
const { useEffect: _, useMemo: h } = __STORYBOOK_MODULE_PREVIEW_API__,
  { global: j } = __STORYBOOK_MODULE_GLOBAL__,
  { logger: X } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
var p = 'backgrounds',
  U = { light: { name: 'light', value: '#F8F8F8' }, dark: { name: 'dark', value: '#333' } },
  { document: b, window: O } = j,
  D = () => {
    var r;
    return !!(
  ...
  N = (r) => {
    var t;
    let e = b.getElementById(r);
    e && ((t = e.parentElement) == null || t.removeChild(e));
  },
  F = (r, e) => {
    let t = b.getElementById(r);
  ...
  Y = (r, e, t) => {
    var a;
    let o = b.getElementById(r);
    if (o) o.innerHTML !== e && (o.innerHTML = e);
    else {
      let d = b.createElement('style');
      (d.setAttribute('id', r), (d.innerHTML = e));
      let i = `addon-backgrounds-grid${t ? `-docs-${t}` : ''}`,
        n = b.getElementById(i);
      n ? (a = n.parentElement) == null || a.insertBefore(d, n) : b.head.appendChild(d);
    }
  },
  W = { cellSize: 100, cellAmount: 10, opacity: 0.8 },
  w = 'addon-backgrounds',
  R = 'addon-backgrounds-grid',
  q = D() ? '' : 'transition: background-color 0.3s;',
  J = (r, e) => {
    let { globals: t, parameters: o, viewMode: a, id: d } = e,
      { options: i = U, disable: n, grid: s = W } = o[p] || {},
      c = t[p] || {},
      u = c.value,
      l = u ? i[u] : void 0,
      $ = (l == null ? void 0 : l.value) || 'transparent',
      f = c.grid || !1,
      y = !!l && !n,
      m = a === 'docs' ? `#anchor--${d} .docs-story` : '.sb-show-main',
      E = a === 'docs' ? `#anchor--${d} .docs-story` : '.sb-show-main',
      H = o.layout === void 0 || o.layout === 'padded',
      L = a === 'docs' ? 20 : H ? 16 : 0,
      { cellAmount: k, cellSize: g, opacity: x, offsetX: v = L, offsetY: S = L } = s,
      B = a === 'docs' ? `${w}-docs-${d}` : `${w}-color`,
      G = a === 'docs' ? d : null;
    _(() => {
      let M = `
    ${m} {
  ...
  Q = (r, e = [], t) => {
    ...
    let o = e.find((a) => a.name === t);
    if (o) return o.value;
    if (t) {
      let a = e.map((d) => d.name).join(', ');
      X.warn(P`
  ...
  Z = (r, e) => {
    ...
    let { globals: t, parameters: o } = e,
      a = (u = t[p]) == null ? void 0 : u.value,
      d = o[p],
      i = h(() => (d.disable ? 'transparent' : Q(a, d.values, d.default)), [d, a]),
      n = h(() => i && i !== 'transparent', [i]),
      s = e.viewMode === 'docs' ? `#anchor--${e.id} .docs-story` : '.sb-show-main',
      c = h(
        () => `
      ${s} {
  ...
  V = (r, e) => {
    ...
    let { globals: t, parameters: o } = e,
      a = o[p].grid,
      d = ((y = t[p]) == null ? void 0 : y.grid) === !0 && a.disable !== !0,
      { cellAmount: i, cellSize: n, opacity: s } = a,
      c = e.viewMode === 'docs',
      u = o.layout === void 0 || o.layout === 'padded' ? 16 : 0,
      l = a.offsetX ?? (c ? 20 : u),
      $ = a.offsetY ?? (c ? 20 : u),
      f = h(() => {
        let m = e.viewMode === 'docs' ? `#anchor--${e.id} .docs-story` : '.sb-show-main',
          E = [
            `${n * i}px ${n * i}px`,
            `${n * i}px ${n * i}px`,
            `${n}px ${n}px`,
  ...
  C,
  ae = (C = globalThis.FEATURES) != null && C.backgroundsStoryGlobals ? [J] : [V, Z],
  I,
  oe = {
    [p]: {
  ...
  ee = { [p]: { value: void 0, grid: !1 } },
  z,
  de = (z = globalThis.FEATURES) != null && z.backgroundsStoryGlobals ? ee : { [p]: null };
