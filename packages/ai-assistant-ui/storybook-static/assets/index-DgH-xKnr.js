      ...
      (function (n, a) {
        (function (o, i) {
          ...
          class p extends Error {
            constructor(t) {
              (super(`No parslet found for token: ${i(t)}`),
                (this.token = t),
          ...
          function X(e) {
            var t, r;
            return (r = (t = $.exec(e)) === null || t === void 0 ? void 0 : t[0]) !== null &&
              r !== void 0
              ? r
              : null;
          }
          ...
          class K {
            ...
            static read(t, r = !1) {
              ...
              for (const s of Kt) {
                const c = s(t);
                if (c !== null) {
                  const y = Object.assign(Object.assign({}, c), { startOfLine: r });
          ...
          function H(e) {
            if (e.type !== 'JsdocTypeKeyValue') throw new d(e);
            return e;
          }
          function Bt(e) {
            var t;
            ...
            if (e.type !== 'JsdocTypeNumber' && e.type !== 'JsdocTypeName') throw new d(e);
            return e;
          }
          function Mt(e) {
            if (
          ...
          class V {
            constructor(t, r, s) {
              ((this.grammar = t),
                typeof r == 'string' ? (this._lexer = K.create(r)) : (this._lexer = r),
                (this.baseParser = s));
            }
            get lexer() {
              return this._lexer;
            ...
            return (r == null && s === '?' && !Ie(c)) || (r != null && s === '?')
              ? (e.consume('?'),
                r == null
                  ...
                  : { type: 'JsdocTypeNullable', element: P(r), meta: { position: 'suffix' } })
              : null;
          };
          function J(e) {
            const t = (r, s, c) => {
              const y = r.lexer.current.type,
                T = r.lexer.next.type;
              if (c === null) {
                if ('parsePrefix' in e && e.accept(y, T)) return e.parsePrefix(r);
              } else if ('parseInfix' in e && e.precedence > s && e.accept(y, T))
                return e.parseInfix(r, c);
              return null;
            };
          ...
          const z = J({
              ...
              parseInfix: (e, t) => (
                e.consume('='),
                { type: 'JsdocTypeOptional', element: P(t), meta: { position: 'suffix' } }
              ),
            }),
            Z = J({
              name: 'numberParslet',
            ...
            Gt = J({
              ...
              parseInfix: (e, t) => (
                e.consume('!'),
                { type: 'JsdocTypeNotNullable', element: P(t), meta: { position: 'suffix' } }
              ),
            });
          function Wt({ allowTrailingComma: e }) {
            return J({
              ...
              parseInfix: (t, r) => {
                ...
                do
                  try {
                    const c = t.parseIntermediateType(m.PARAMETER_LIST);
                    s.push(ie(c));
                  } catch (c) {
                    if (c instanceof p) break;
                    throw c;
                  }
                while (t.consume(','));
          ...
          const Xt = J({
              ...
              parseInfix: (e, t) => {
                ...
                if (e.consume('infer')) {
                  c = !0;
                  const y = e.parseIntermediateType(m.SYMBOL);
                  ...
                  do s.push(e.parseType(m.PARAMETER_LIST));
                  while (e.consume(','));
                if (!e.consume('>')) throw new Error('Unterminated generic parameter list');
                return Object.assign(
                  Object.assign(
                    { type: 'JsdocTypeGeneric', left: P(t), elements: s },
                    c ? { infer: !0 } : {},
                  ),
                  { meta: { brackets: 'angle', dot: r } },
                );
              },
            }),
            Qt = J({
              ...
              parseInfix: (e, t) => {
                e.consume('|');
                const r = [];
                do r.push(e.parseType(m.UNION));
                while (e.consume('|'));
                return { type: 'JsdocTypeUnion', elements: [P(t), ...r] };
              },
            }),
            pe = [le, z, Z, Ct, Yt, Gt, Wt({ allowTrailingComma: !0 }), Xt, Qt, z];
          function ee({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: r }) {
            return function (c, y, T) {
              if (T == null || y >= m.NAME_PATH) return null;
              const g = c.lexer.current.type,
                k = c.lexer.next.type;
              if (
                !(
                  (g === '.' && k !== '<') ||
                  (g === '[' && (e || T.type === 'JsdocTypeName')) ||
                  (t && (g === '~' || g === '#'))
                )
              )
                return null;
              ...
              c.consume('.')
                ? (S = 'property')
                : c.consume('[')
                  ? ((S = 'property-brackets'), (re = !0))
                  : c.consume('~')
                    ? (S = 'inner')
                    : (c.consume('#'), (S = 'instance'));
              const De = r !== null ? new V(r, c.lexer, c) : c,
                O = De.parseIntermediateType(m.NAME_PATH);
              c.acceptLexerState(De);
              let B;
              switch (O.type) {
                case 'JsdocTypeName':
              ...
              if (re && !c.consume(']')) {
                ...
                throw new Error(
                  `Unterminated square brackets. Next token is '${qe.type}' with text '${qe.text}'`,
                );
              }
              return { type: 'JsdocTypeNamePath', left: P(T), right: B, pathType: S };
            };
          }
            ...
            return J({
              ...
              parsePrefix: (r) => {
                ...
                if (r.consume('StringValue'))
                  ...
                  let k = '';
                  const x = ['Identifier', '@', '/'];
                  for (; x.some((S) => r.consume(S)); ) ((k += y.text), (y = r.lexer.current));
                  c = {
                    type: 'JsdocTypeSpecialNamePath',
                    value: k,
                    specialType: s,
                ...
                const T = new V(e, r.lexer, r),
                  g = T.parseInfixIntermediateType(c, m.ALL);
                return (r.acceptLexerState(T), P(g));
              },
            });
          }
          const Re = [
              ...
              D,
              Z,
              ee({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: null }),
            ],
            U = [...Re, te({ allowedTypes: ['event'], pathGrammar: Re })];
          function ue(e) {
            let t;
          ...
          function Ht(e) {
            const t = ue(e);
            if (t.some((r) => r.type === 'JsdocTypeKeyValue'))
          ...
          function ye({
            ...
            return J({
              ...
              accept: (c, y) => c === 'function' || (s && c === 'new' && y === '('),
              parsePrefix: (c) => {
                const y = c.consume('new');
                c.consume('function');
                ...
                const k = c.parseIntermediateType(m.FUNCTION);
                if (e === void 0) g.parameters = Ht(k);
                else {
                ...
                if (c.consume(':')) g.returnType = c.parseType(m.PREFIX);
                else if (!t) throw new Error('function is missing return type');
                return g;
              },
            });
          }
          function de({ allowPostfix: e, allowEnclosingBrackets: t }) {
            return J({
              ...
              parsePrefix: (r) => {
                ...
                const s = t && r.consume('[');
                try {
                  const c = r.parseType(m.PREFIX);
                  if (s && !r.consume(']'))
                    throw new Error("Unterminated variadic type. Missing ']'");
                  return {
                    type: 'JsdocTypeVariadic',
                    element: P(c),
                    meta: { position: 'prefix', squareBrackets: s },
                  };
                } catch (c) {
                  if (c instanceof p) {
          ...
          function me({ objectFieldGrammar: e, allowKeyTypes: t }) {
            return J({
              name: 'objectParslet',
              accept: (r) => r === '{',
              parsePrefix: (r) => {
                ...
                if (!r.consume('}')) {
                  let c;
                  const y = new V(e, r.lexer, r);
                  for (;;) {
                    y.acceptLexerState(r);
                    let T = y.parseIntermediateType(m.OBJECT);
                    (r.acceptLexerState(y),
                      T === void 0 && t && (T = r.parseIntermediateType(m.OBJECT)));
                    let g = !1;
                    if (
                      (T.type === 'JsdocTypeNullable' && ((g = !0), (T = T.element)),
                      T.type === 'JsdocTypeNumber' ||
                        T.type === 'JsdocTypeName' ||
                        T.type === 'JsdocTypeStringValue')
                    ) {
                      let x;
                      (T.type === 'JsdocTypeStringValue' && (x = T.meta.quote),
                        s.elements.push({
                    ...
                    if (r.lexer.current.startOfLine)
                      ((c = 'linebreak'), r.consume(',') || r.consume(';'));
                  ...
                  if (
                    ((s.meta.separator = c ?? 'comma'),
                    c === 'linebreak' && (s.meta.propertyIndent = '  '),
                    !r.consume('}'))
                  )
          ...
          function fe({
            ...
            return J({
              ...
              parseInfix: (c, y) => {
                ...
                let g = !1,
                  k = !1;
                (s && y.type === 'JsdocTypeNullable' && ((g = !0), (y = y.element)),
                  r && y.type === 'JsdocTypeReadonlyProperty' && ((k = !0), (y = y.element)));
                const x = (T = c.baseParser) !== null && T !== void 0 ? T : c;
                if (
                  (x.acceptLexerState(c),
                  y.type === 'JsdocTypeNumber' ||
                    y.type === 'JsdocTypeName' ||
                    y.type === 'JsdocTypeStringValue' ||
                    ce(y))
                ) {
                  if (ce(y) && !e) throw new d(y);
                  x.consume(':');
                  let S;
                  y.type === 'JsdocTypeStringValue' && (S = y.meta.quote);
                  const re = x.parseType(m.KEY_VALUE);
                  return (
                    c.acceptLexerState(x),
                    {
                      type: 'JsdocTypeObjectField',
                      key: ce(y) ? y : y.value.toString(),
                      right: re,
                      optional: g,
                      readonly: k,
                      meta: { quote: S },
                  ...
                  if (!t) throw new d(y);
                  x.consume(':');
                  const S = x.parseType(m.KEY_VALUE);
                  return (
                    c.acceptLexerState(x),
                    { type: 'JsdocTypeJsdocObjectField', left: P(y), right: S }
                  );
                }
              },
            });
          }
          function Te({ allowOptional: e, allowVariadic: t }) {
            return J({
              ...
              parseInfix: (r, s) => {
                ...
                if (
                  ...
                  throw new d(s);
                r.consume(':');
                const T = r.parseType(m.KEY_VALUE);
                return {
          ...
          const Le = [
              ...
              D,
              te({ allowedTypes: ['module', 'external', 'event'], pathGrammar: U }),
              de({ allowEnclosingBrackets: !0, allowPostfix: !0 }),
              A({ allowedAdditionalTokens: ['keyof'] }),
              _e,
              Fe,
              ee({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: U }),
            ],
            zt = [
              ...Le,
              me({
              ...
              Te({ allowOptional: !0, allowVariadic: !0 }),
            ],
            je = J({
              name: 'typeOfParslet',
              accept: (e) => e === 'typeof',
              parsePrefix: (e) => (
                e.consume('typeof'),
                { type: 'JsdocTypeTypeof', element: e.parseType(m.KEY_OF_TYPE_OF) }
              ),
            }),
            Zt = [
              A({
            ...
            en = [
              ...pe,
              me({ allowKeyTypes: !1, objectFieldGrammar: Zt }),
              ...
              A({ allowedAdditionalTokens: ['keyof'] }),
              te({ allowedTypes: ['module'], pathGrammar: U }),
              ee({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: U }),
              Te({ allowOptional: !1, allowVariadic: !1 }),
              _e,
            ],
            tn = J({
              name: 'assertsParslet',
              ...
              parsePrefix: (e) => {
                ...
                return e.consume('is')
                  ? {
                      ...
                      left: t,
                      right: P(e.parseIntermediateType(m.INFIX)),
                    }
                  : { type: 'JsdocTypeAssertsPlain', element: t };
              },
            });
          function nn({ allowQuestionMark: e }) {
            return J({
              name: 'tupleParslet',
              accept: (t) => t === '[',
              parsePrefix: (t) => {
                ...
                if (
                  (s.type === 'JsdocTypeParameterList'
                    ? s.elements[0].type === 'JsdocTypeKeyValue'
                      ? (r.elements = s.elements.map(H))
                      : (r.elements = s.elements.map(P))
                ...
                if (r.elements.some((c) => c.type === 'JsdocTypeUnknown'))
          ...
          const rn = J({
              ...
              parsePrefix: (e) => (
                e.consume('keyof'),
                { type: 'JsdocTypeKeyof', element: P(e.parseType(m.KEY_OF_TYPE_OF)) }
              ),
            }),
            an = J({
              name: 'importParslet',
            ...
            on = J({
              ...
              parsePrefix: (e) => (
                e.consume('readonly'),
                { type: 'JsdocTypeReadonlyProperty', element: e.parseIntermediateType(m.KEY_VALUE) }
              ),
            }),
            sn = J({
            ...
            cn = J({
              ...
              parsePrefix: (e) => {
                ...
                do {
                  let s,
                    c = e.parseIntermediateType(m.SYMBOL);
                  if (
                    (c.type === 'JsdocTypeOptional' &&
                      ((c = c.element), (s = e.parseType(m.SYMBOL))),
                    c.type !== 'JsdocTypeName')
                  )
                    throw new d(c);
                  let y;
                  e.consume('extends') &&
                    ((y = e.parseType(m.SYMBOL)),
                    y.type === 'JsdocTypeOptional' &&
                      ((y = y.element), (s = e.parseType(m.SYMBOL))));
                  const T = { type: 'JsdocTypeTypeParameter', name: c };
                  if (
                    (y !== void 0 && (T.constraint = y),
                    s !== void 0 && (T.defaultValue = s),
                    t.push(T),
                    e.consume('>'))
                  )
                    break;
                } while (e.consume(','));
                const r = e.parseIntermediateType(m.SYMBOL);
            ...
            ln = J({
              ...
              parseInfix: (e, t) => {
                e.consume('&');
                const r = [];
                do r.push(e.parseType(m.INTERSECTION));
                while (e.consume('&'));
                return { type: 'JsdocTypeIntersection', elements: [P(t), ...r] };
              },
            }),
            pn = J({
            ...
            yn = J({
              ...
              parsePrefix: (e) => (
                e.consume('readonly'),
                { type: 'JsdocTypeReadonlyArray', element: Mt(e.parseIntermediateType(m.ALL)) }
              ),
            }),
            dn = J({
              ...
              parseInfix: (e, t) => {
                e.consume('extends');
                const r = e.parseType(m.KEY_OF_TYPE_OF).element,
                  s = e.parseType(m.INFIX);
                return (
                  e.consume(':'),
                  {
            ...
            fn = [
              ...pe,
              me({ allowKeyTypes: !1, objectFieldGrammar: mn }),
              yn,
              je,
              rn,
              an,
              ...
              sn,
              cn,
              ee({ allowSquareBracketsOnAnyType: !0, allowJsdocNamePaths: !1, pathGrammar: U }),
              ln,
              pn,
              Te({ allowVariadic: !0, allowOptional: !0 }),
            ];
          function Ve(e, t) {
            switch (t) {
              case 'closure':
                return new V(en, e).parse();
              case 'jsdoc':
                return new V(zt, e).parse();
              case 'typescript':
                return new V(fn, e).parse();
            }
          }
          function Tn(e, t = ['typescript', 'closure', 'jsdoc']) {
            let r;
            for (const s of t)
              try {
                return Ve(e, s);
            ...
            return {
              ...
              JsdocTypeFunction: (e, t) => {
                ...
                if (e.arrow) {
                  ...
                  let s = `${e.typeParameters !== void 0 ? `<${(r = e.typeParameters.map(t).join(', ')) !== null && r !== void 0 ? r : ''}>` : ''}(${e.parameters.map(t).join(', ')}) => ${t(e.returnType)}`;
                  return (e.constructor && (s = 'new ' + s), s);
                } else {
                  let s = e.constructor ? 'new' : 'function';
                  return (
                    e.parenthesis &&
                      ((s += `(${e.parameters.map(t).join(', ')})`),
                      e.returnType !== void 0 && (s += `: ${t(e.returnType)}`)),
                    s
                  );
                }
              },
              ...
              JsdocTypeVariadic: (e, t) =>
                e.meta.position === void 0 ? '...' : ne(e.meta.position, t(e.element), '...'),
              ...
              JsdocTypeStringValue: (e) => I(e.value, e.meta.quote),
              JsdocTypeAny: () => '*',
              JsdocTypeGeneric: (e, t) => {
                if (e.meta.brackets === 'square') {
                  const r = e.elements[0],
                    s = t(r);
                  return r.type === 'JsdocTypeUnion' || r.type === 'JsdocTypeIntersection'
                    ? `(${s})[]`
                    : `${s}[]`;
                } else
              ...
              JsdocTypeObjectField: (e, t) => {
                ...
                return (
                  ...
                  typeof e.key == 'string' ? (r += I(e.key, e.meta.quote)) : (r += t(e.key)),
                  e.optional && (r += '?'),
              ...
              JsdocTypeSpecialNamePath: (e) => `${e.specialType}:${I(e.value, e.meta.quote)}`,
              JsdocTypeNotNullable: (e, t) => ne(e.meta.position, t(e.element), '!'),
              JsdocTypeNull: () => 'null',
              JsdocTypeNullable: (e, t) => ne(e.meta.position, t(e.element), '?'),
              ...
              JsdocTypeObject: (e, t) => {
                ...
                return `{${
                  (e.meta.separator === 'linebreak' && e.elements.length > 1
                    ? `
` + ((r = e.meta.propertyIndent) !== null && r !== void 0 ? r : '')
                    : '') +
                  e.elements.map(t).join(
                    e.meta.separator === 'comma'
                      ...
                      : e.meta.separator === 'linebreak'
                        ? `
` + ((s = e.meta.propertyIndent) !== null && s !== void 0 ? s : '')
                        : '; ',
                  ) +
                  (e.meta.separator === 'linebreak' && e.elements.length > 1
                    ? `
`
              ...
              JsdocTypeOptional: (e, t) => ne(e.meta.position, t(e.element), '='),
              ...
              JsdocTypeProperty: (e) => I(e.value, e.meta.quote),
          ...
          function R(e) {
            ...
            return (gn.includes(e) && (t.reservedWord = !0), t);
          }
          const wn = {
            ...
            JsdocTypeStringValue: (e) => R(I(e.value, e.meta.quote)),
            ...
            JsdocTypeSpecialNamePath: (e) => R(e.specialType + ':' + I(e.value, e.meta.quote)),
            JsdocTypeName: (e) =>
              e.value !== 'function' ? R(e.value) : { type: 'FunctionType', params: [] },
            ...
            JsdocTypeNamePath: (e, t) => {
              ...
              e.right.type === 'JsdocTypeSpecialNamePath'
                ? (s = t(e.right).name)
                : (s = I(e.right.value, e.right.meta.quote));
            ...
            JsdocTypeSymbol: (e) => {
              ...
              return (
                ...
                (r == null ? void 0 : r.type) === 'JsdocTypeName'
                  ? (t += r.value)
                  : (r == null ? void 0 : r.type) === 'JsdocTypeNumber' &&
                    (t += r.value.toString()),
                s && (t += '...'),
                R(`${e.value}(${t})`)
              );
          ...
          function he(e, t) {
            return t.length === 2
              ...
              : { type: e, left: t[0], right: he(e, t.slice(1)) };
          }
          const bn = {
            JsdocTypeOptional: (e, t) => ({
              type: 'OPTIONAL',
            ...
            JsdocTypeNullable: (e, t) => ({
              ...
              meta: {
                syntax:
                  e.meta.position === 'prefix' ? 'PREFIX_QUESTION_MARK' : 'SUFFIX_QUESTION_MARK',
              },
            }),
            JsdocTypeNotNullable: (e, t) => ({
              type: 'NOT_NULLABLE',
            ...
            JsdocTypeSpecialNamePath: (e) => {
              ...
              return {
                type: 'MODULE',
                value: { type: 'FILE_PATH', quoteStyle: L(e.meta.quote), path: e.value },
              };
            },
            JsdocTypeNamePath: (e, t) => {
              let r = !1,
              ...
              e.right.type === 'JsdocTypeSpecialNamePath' && e.right.specialType === 'event'
                ? ((r = !0), (s = e.right.value), (c = L(e.right.meta.quote)))
                : ((s = e.right.value), (c = L(e.right.meta.quote)));
              const y = {
                type: Nn(e.pathType),
                owner: t(e.left),
                name: s,
              ...
              if (y.owner.type === 'MODULE') {
                const T = y.owner;
                return ((y.owner = y.owner.value), (T.value = y), T);
              } else return y;
            },
            JsdocTypeUnion: (e, t) => he('UNION', e.elements.map(t)),
            JsdocTypeParenthesis: (e, t) => ({ type: 'PARENTHESIS', value: t(P(e.element)) }),
            ...
            JsdocTypeIntersection: (e, t) => he('INTERSECTION', e.elements.map(t)),
          ...
          function vn() {
            return {
              ...
              JsdocTypeTypeParameter: (e, t) => ({
                ...
                defaultValue: e.defaultValue !== void 0 ? t(e.defaultValue) : void 0,
              }),
            };
          }
          const Ke = {
          ...
          function Je(e, t, r, s, c) {
            s == null || s(e, t, r);
            const y = Ke[e.type];
            for (const T of y) {
              const g = e[T];
              if (g !== void 0)
                if (Array.isArray(g)) for (const k of g) Je(k, e, T, s, c);
                else Je(g, e, T, s, c);
            }
            c == null || c(e, t, r);
          }
          function xn(e, t, r) {
            Je(e, void 0, void 0, t, r);
          }
          ((o.catharsisTransform = Pn),
            (o.identityTransformRules = vn),
            (o.jtpTransform = En),
            (o.parse = Ve),
            (o.stringify = Jn),
            (o.stringifyRules = $e),
...
var ge = Sn(),
  ...
  l = (n, a) => On(n, 'name', { value: a, configurable: !0 });
const { UnknownArgTypesError: An } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var In = l((n) => n.name === 'literal', 'isLiteral'),
  Rn = l((n) => n.value.replace(/['|"]/g, ''), 'toEnumOption'),
  _n = l((n) => {
    switch (n.type) {
      case 'function':
      ...
      default:
        throw new An({ type: n, language: 'Flow' });
    }
  }, 'convertSig'),
  Y = l((n) => {
    var p, u, d, f;
    ...
    switch ((typeof o < 'u' && (i.raw = o), n.name)) {
      ...
      case 'signature':
        return { ...i, ..._n(n) };
      case 'union':
        return (p = n.elements) != null && p.every(In)
          ? { ...i, name: 'enum', value: (u = n.elements) == null ? void 0 : u.map(Rn) }
          : { ...i, name: a, value: (d = n.elements) == null ? void 0 : d.map(Y) };
      case 'intersection':
        return { ...i, name: a, value: (f = n.elements) == null ? void 0 : f.map(Y) };
      default:
...
l(Me, 'mapValues');
var Ce = /^['"]|['"]$/g,
  Fn = l((n) => n.replace(Ce, ''), 'trimQuotes'),
  Ln = l((n) => Ce.test(n), 'includesQuotes'),
  Ye = l((n) => {
    let a = Fn(n);
    return Ln(n) || Number.isNaN(Number(a)) ? a : Number(a);
  }, 'parseLiteral'),
  jn = /^\(.*\) => /,
  C = l((n) => {
    ...
    switch ((typeof o < 'u' && (u.raw = o), a)) {
      case 'enum': {
        let f = i ? p : p.map((h) => Ye(h.value));
        return { ...u, name: a, value: f };
      }
      case 'string':
      case 'number':
      case 'symbol':
      ...
      case 'arrayOf':
      case 'array':
        return { ...u, name: 'array', value: p && C(p) };
      case 'object':
        return { ...u, name: a };
      case 'objectOf':
        return { ...u, name: a, value: C(p) };
      case 'shape':
      case 'exact':
        let d = Me(p, (f) => C(f));
        return { ...u, name: 'object', value: d };
      case 'union':
        return { ...u, name: 'union', value: p.map((f) => C(f)) };
      case 'instanceOf':
      case 'element':
      case 'elementType':
      default: {
        if ((a == null ? void 0 : a.indexOf('|')) > 0)
          try {
            let v = a.split('|').map((N) => JSON.parse(N));
            return { ...u, name: 'enum', value: v };
          } catch {}
        let f = p ? `${a}(${p})` : a,
          h = jn.test(a) ? 'function' : 'other';
        return { ...u, name: h, value: f };
      }
    }
  }, 'convert');
const { UnknownArgTypesError: Vn } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var Un = l((n) => {
    switch (n.type) {
      case 'function':
        return { name: 'function' };
      ...
      default:
        throw new Vn({ type: n, language: 'Typescript' });
    }
  }, 'convertSig'),
  G = l((n) => {
    var p, u, d, f;
    ...
    switch ((typeof o < 'u' && (i.raw = o), n.name)) {
      ...
      case 'boolean':
        return { ...i, name: a };
      case 'Array':
        return { ...i, name: 'array', value: n.elements.map(G) };
      case 'signature':
        return { ...i, ...Un(n) };
      case 'union':
        let h;
        return (
          (p = n.elements) != null && p.every((v) => v.name === 'literal')
            ? (h = {
                ...i,
                name: 'enum',
                value: (u = n.elements) == null ? void 0 : u.map((v) => Ye(v.value)),
              })
            : (h = { ...i, name: a, value: (d = n.elements) == null ? void 0 : d.map(G) }),
          h
        );
      case 'intersection':
        return { ...i, name: a, value: (f = n.elements) == null ? void 0 : f.map(G) };
      default:
        return { ...i, name: 'other', value: a };
    }
  }, 'convert'),
  we = l((n) => {
    ...
    try {
      ...
      if (o != null) return G(o);
      if (i != null) return Y(i);
    } catch (p) {
      console.error(p);
    }
    return null;
  ...
  Kn = ['null', 'undefined'];
function ae(n) {
  return Kn.some((a) => a === n);
}
l(ae, 'isDefaultValueBlacklisted');
var Dn = l((n) => {
  if (!n) return '';
...
l(Ge, 'isValidDocgenSection');
function We(n, a) {
  return Pe(n) ? n.__docgenInfo[a] : null;
}
l(We, 'getDocgenSection');
function Xe(n) {
  return Pe(n) ? Dn(n.__docgenInfo.description) : '';
}
l(Xe, 'getDocgenDescription');
var _;
(function (n) {
...
function tt({ fence: n = '```' } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let d of i)
      (qn.test(d.tokens.description) && !u ? p.push([d]) : p[p.length - 1].push(d),
        (u = o(d.tokens.description, u)));
    return p;
  }, 'parseBlock');
}
l(tt, 'getParser');
...
l(nt, 'getFencer');
function rt({ startLine: n = 0, markers: a = _ } = {}) {
  let o = null,
    i = n;
  return l(function (p) {
    let u = p,
    ...
    if (
      ...
      o === null &&
        ...
        ((o = []),
        (d.delimiter = u.slice(0, a.start.length)),
        (u = u.slice(a.start.length)),
        ([d.postDelimiter, u] = j(u))),
      o === null)
    )
      return (i++, null);
    let f = u.trimRight().endsWith(a.end);
    if (
      (d.delimiter === '' &&
        u.startsWith(a.delim) &&
        !u.startsWith(a.end) &&
        ((d.delimiter = a.delim), (u = u.slice(a.delim.length)), ([d.postDelimiter, u] = j(u))),
      f)
    ) {
      let h = u.trimRight();
      ((d.end = u.slice(h.length - a.end.length)), (u = h.slice(0, -a.end.length)));
    }
    if (((d.description = u), o.push({ number: i, source: p, tokens: d }), i++, f)) {
      let h = o.slice();
      return ((o = null), h);
    }
    return null;
...
function at({ tokenizers: n }) {
  return l(function (a) {
    ...
    for (let p of n)
      if (
        ((i = p(i)),
        !((o = i.problems[i.problems.length - 1]) === null || o === void 0) && o.critical)
      )
        break;
    return i;
  }, 'parseSpec');
...
function ot() {
  return (n) => {
    ...
    return o === null
      ...
      : ((a.tag = o[1]),
        (a.postTag = o[3]),
        (a.description = a.description.slice(o[0].length)),
        (n.tag = o[2]),
        n);
  };
}
l(ot, 'tagTokenizer');
function st(n = 'compact') {
  let a = it(n);
  return (o) => {
    let i = 0,
      p = [];
    for (let [f, { tokens: h }] of o.source.entries()) {
      let v = '';
      if (f === 0 && h.description[0] !== '{') return o;
      for (let N of h.description)
        if ((N === '{' && i++, N === '}' && i--, (v += N), i === 0)) break;
      if ((p.push([h, v]), i === 0)) break;
    }
    if (i !== 0)
      return (
        o.problems.push({
    ...
    let u = [],
      d = p[0][0].postDelimiter.length;
    for (let [f, [h, v]] of p.entries())
      ((h.type = v),
        f > 0 &&
          ((h.type = h.postDelimiter.slice(d) + v),
          (h.postDelimiter = h.postDelimiter.slice(0, d))),
        ([h.postType, h.description] = j(h.description.slice(v.length))),
        u.push(h.type));
    return (
      (u[0] = u[0].slice(1)),
...
l(it, 'getJoiner');
var Mn = l((n) => n && n.startsWith('"') && n.endsWith('"'), 'isQuoted');
function ct() {
  ...
  return (a) => {
    ...
    if (p.length > 1 && p[0] === '' && p.length % 2 === 1)
      return (
        (a.name = p[1]),
        (o.name = `"${p[1]}"`),
        ([o.postName, o.description] = j(i.slice(o.name.length))),
        a
      );
    let u = 0,
      d = '',
    ...
    if (d[0] === '[' && d[d.length - 1] === ']') {
      ((f = !0), (d = d.slice(1, -1)));
      let N = d.split('=');
      if (((d = N[0].trim()), N[1] !== void 0 && (h = N.slice(1).join('=').trim()), d === ''))
        return (
          a.problems.push({
...
function Ne(n) {
  return n === 'compact' ? pt : n === 'preserve' ? ut : n;
}
l(Ne, 'getJoiner');
function pt(n, a = _) {
  return n
...
l(pt, 'compactJoiner');
var Cn = l((n, { tokens: a }, o) => (a.type === '' ? n : o), 'lineNo'),
  Yn = l(
...
function ut(n, a = _) {
  ...
  return (
    o !== void 0 &&
      o.tokens.description === '' &&
      o.tokens.end.endsWith(a.end) &&
      (n = n.slice(0, -1)),
    (n = n.slice(n.reduce(Cn, 0))),
    n.map(Yn).join(`
`)
  );
}
...
function yt({
  ...
  spacing: o = 'compact',
  markers: i = _,
  tokenizers: p = [ot(), st(o), ct(), lt(o)],
} = {}) {
  if (n < 0 || n % 1 > 0) throw new Error('Invalid startLine');
  let u = rt({ startLine: n, markers: i }),
    d = tt({ fence: a }),
    f = at({ tokenizers: p }),
    h = Ne(o);
  return function (v) {
    ...
    for (let oe of ze(v)) {
      ...
      N.push({
        ...
        tags: Q,
        source: $,
        problems: Q.reduce((b, se) => b.concat(se.problems), []),
      });
    }
    return N;
  };
...
function Gn() {
  return (n) =>
    n.source.map(({ tokens: a }) => dt(a)).join(`
`);
}
l(Gn, 'getStringifier');
function mt(n, a = {}) {
...
`) +
      `
*/`,
    o = mt(a, { spacing: 'preserve' });
  if (!o || o.length === 0) throw new Error('Cannot parse JSDoc tags.');
  return o[0];
}
l(Tt, 'parse');
var Wn = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  Xn = l((n, a = Wn) => {
    if (!ft(n)) return { includesJsDoc: !1, ignore: !1 };
    let o = Tt(n),
      i = ht(o, a.tags);
    return i.ignore
...
l(ht, 'extractJsDocTags');
function Jt(n) {
  return n.replace(/[\.-]$/, '');
}
l(Jt, 'normaliseParamName');
function gt(n) {
  ...
  return {
    name: n.name,
    type: a,
    description: Ee(n.description),
    getPrettyName: l(() => Jt(n.name), 'getPrettyName'),
    getTypeName: l(() => (a ? xe(a) : null), 'getTypeName'),
  };
}
l(gt, 'extractParam');
function wt(n) {
  return n.name ? be(n.name, n.description) : null;
}
l(wt, 'extractDeprecated');
function be(n, a) {
  let o = n === '' ? a : `${n} ${a}`;
  return Ee(o);
}
l(be, 'joinNameAndDescription');
function Ee(n) {
  let a = n.replace(/^- /g, '').trim();
  return a === '' ? null : a;
}
l(Ee, 'normaliseDescription');
function Pt(n) {
  let a = ve(n.type);
  return a
    ? {
        type: a,
        description: be(n.name, n.description),
        getTypeName: l(() => xe(a), 'getTypeName'),
      }
    : null;
}
l(Pt, 'extractReturns');
var F = ge.stringifyRules(),
  Qn = F.JsdocTypeObject;
F.JsdocTypeAny = () => 'any';
F.JsdocTypeObject = (n, a) => `(${Qn(n, a)})`;
...
l(ve, 'extractType');
function xe(n) {
  return ge.transform(F, n);
}
l(xe, 'extractTypeName');
function ke(n) {
  return n.length > 90;
}
...
l(E, 'createSummaryValue');
function bt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!ae(o)) return Nt(o) ? E(a == null ? void 0 : a.name, o) : E(o);
  }
  return null;
}
l(bt, 'createDefaultValue');
function Se({ name: n, value: a, elements: o, raw: i }) {
  return a ?? (o != null ? o.map(Se).join(' | ') : (i ?? n));
}
l(Se, 'generateUnionElement');
function Et({ name: n, raw: a, elements: o }) {
  return o != null ? E(o.map(Se).join(' | ')) : a != null ? E(a.replace(/^\|\s*/, '')) : E(n);
}
l(Et, 'generateUnion');
function vt({ type: n, raw: a }) {
  return a != null ? E(a) : E(n);
}
l(vt, 'generateFuncSignature');
function xt({ type: n, raw: a }) {
  return a != null ? (ke(a) ? E(n, a) : E(a)) : E(n);
}
l(xt, 'generateObjectSignature');
function kt(n) {
  let { type: a } = n;
  return a === 'object' ? xt(n) : vt(n);
}
l(kt, 'generateSignature');
function St({ name: n, raw: a }) {
  return a != null ? (ke(a) ? E(n, a) : E(a)) : E(n);
}
l(St, 'generateDefault');
function Ot(n) {
...
var Hn = l((n, a) => {
  ...
  return {
    ...
    required: p,
    description: i,
    defaultValue: bt(u ?? null, o ?? null),
  };
}, 'createFlowPropDef');
function At({ defaultValue: n }) {
  if (n != null) {
    let { value: a } = n;
    if (!ae(a)) return E(a);
  }
...
l(At, 'createDefaultValue');
function It({ tsType: n, required: a }) {
  if (n == null) return null;
  let o = n.name;
  return (
    a || (o = o.replace(' | undefined', '')),
    E(['Array', 'Record', 'signature'].includes(n.name) ? n.raw : o)
  );
}
l(It, 'createType');
var zn = l((n, a) => {
  let { description: o, required: i } = a;
  return { name: n, type: It(a), required: i, description: o, defaultValue: At(a) };
}, 'createTsPropDef');
function Rt(n) {
  return n != null ? E(n.name) : null;
}
l(Rt, 'createType');
function _t(n) {
    ...
    ? n.name === 'string'
      ...
      : n.name === 'enum'
        ? Array.isArray(n.value) &&
          n.value.every(
            ({ value: a }) => typeof a == 'string' && a[0] === '"' && a[a.length - 1] === '"',
          )
        : !1
    : !1;
}
...
function Lt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!ae(o)) return _t(n) && Ft(a) ? E(JSON.stringify(o)) : E(o);
  }
  return null;
}
l(Lt, 'createDefaultValue');
function Oe(n, a, o) {
  let { description: i, required: p, defaultValue: u } = o;
  return { name: n, type: Rt(a), required: p, description: i, defaultValue: Lt(u, a) };
}
    ...
    let u = {
      ...
      params:
        (o = p == null ? void 0 : p.params) == null
          ? void 0
          : o.map((d) => ({ name: d.getPrettyName(), description: d.description })),
    };
    Object.values(u).filter(Boolean).length > 0 && (n.jsDocTags = u);
  }
  return n;
}
l(W, 'applyJsDocResult');
var Zn = l((n, a, o) => {
    let i = Oe(n, a.type, a);
    return ((i.sbType = we(a)), W(i, o));
  }, 'javaScriptFactory'),
  er = l((n, a, o) => {
    let i = zn(n, a);
    return ((i.sbType = we(a)), W(i, o));
  ...
  rr = l((n) => {
    ...
    return n.map((i) => {
      ...
      return (
        (u = i.type) != null &&
          u.elements &&
          (p = { ...i, type: { ...i.type, value: i.type.elements } }),
        Ae(p.name, p, a, o)
      );
    });
  ...
  ar = l((n) => {
    ...
    return a
      .map((p) => {
        let u = n[p];
        return u != null ? Ae(p, u, o, i) : null;
      })
      .filter(Boolean);
  }, 'extractComponentSectionObject'),
  lr = l((n, a) => {
    let o = We(n, a);
    return Ge(o) ? (Array.isArray(o) ? rr(o) : ar(o)) : [];
  }, 'extractComponentProps');
function Ae(n, a, o, i) {
  let p = Xn(a.description);
...
l(or, 'extractComponentDescription');
...
var pr = l((n) => {
  ...
  ir = 'storybook/docs',
  ur = `${ir}/snippet-rendered`,
  cr = ((n) => ((n.AUTO = 'auto'), (n.CODE = 'code'), (n.DYNAMIC = 'dynamic'), n))(cr || {});
export {
  ke as B,
  We as Y,
  Nt as a,
