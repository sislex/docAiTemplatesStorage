try {
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e)
            if (((a = n), (a && typeof a == 'object' && ((a = Fe(t, a)), !a)) || !t.has(a)))
              return !1;
          return !0;
        }
        if (r === Map) {
          ...
          for (n of e)
            if (
              ((a = n[0]),
              (a && typeof a == 'object' && ((a = Fe(t, a)), !a)) || !L(n[1], t.get(a)))
            )
              return !1;
          return !0;
        }
        ...
        if (!r || typeof e == 'object') {
          n = 0;
          for (r in e)
            if ((Be.call(e, r) && ++n && !Be.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1;
    ...
    function $(e, t, r, n) {
      if (typeof e == 'string' && typeof t == 'number') {
        ...
        if (
          ...
          return n >= 1 ? oe(e, t, r) : 'rgba(' + e + ',' + t + ',' + r + ',' + n + ')';
        if (typeof e == 'object' && t === void 0 && r === void 0 && n === void 0)
          return e.alpha >= 1
    ...
    var Ol = v(Ut);
    function jt(e, t) {
      return t === 'transparent' ? t : C(T({}, A(t), { lightness: parseFloat(e) }));
    }
    var Tl = v(jt);
    function kt(e, t) {
      return t === 'transparent' ? t : C(T({}, A(t), { saturation: parseFloat(e) }));
    }
    var _l = v(kt);
    function Gt(e, t) {
    ...
    function Vt(e, t) {
      ...
      var r = I(t),
        n = typeof r.alpha == 'number' ? r.alpha : 1,
        a = T({}, r, { alpha: D(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100) });
      return $(a);
    }
    var Rl = v(Vt);
    var $t = 'actions',
      ...
      fe = (e, t) =>
        function () {
          return (t || (0, e[tt(e)[0]])((t = { exports: {} }).exports, t), t.exports);
        },
      Kt = (e, t) => {
      ...
      Qt = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of tt(t))
            !Zt.call(e, a) &&
              a !== r &&
              pe(e, a, { get: () => t[a], enumerable: !(n = qt(t, a)) || n.enumerable });
        return e;
      },
      er = (e, t, r) => (
        (r = e != null ? Jt(Xt(e)) : {}),
        Qt(t || !e || !e.__esModule ? pe(r, 'default', { value: e, enumerable: !0 }) : r, e)
      ),
      tr = fe({
    ...
    var ar = {
      ...
      de =
        ...
        ({ theme: t = le, ...r }) => {
          ...
          return o.createElement(nt.Provider, { value: n }, o.createElement(e, { ...r }));
        },
            ...
            let u = l.split('.'),
              c = (p, d, f) => {
                ...
                if (f === 0) J(p, t) && (E === X || E === Xe) && c(p, X, f + 1);
                  ...
                  for (let { name: m, data: y } of t(p)) J(y, t) && c(y, `${d}.${m}`, f + 1);
                else {
                  let m = p[E];
                  J(m, t) && c(m, `${d}.${E}`, f + 1);
                }
    ...
    var ce = ({ data: e }) => {
        ...
        if (Array.isArray(r)) {
          let n = t.arrayMaxProperties,
            a = r.slice(0, n).map((s, l) => o.createElement(H, { key: l, object: s }));
      ...
      gr = ({ showNonenumerable: e = !1, sortObjectKeys: t, nodeRenderer: r, ...n }) => {
        let a = dr(e, t),
          i = r || mr;
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Ke = ({
        ...
        return o.createElement(
          ...
          t && o.createElement(yr, null, o.createElement(Or, { sortAscending: e })),
        );
      },
      Tr = ({
      ...
      _r = ({ data: e, columns: t }) => {
        let r = S('TableInspector'),
          [{ sorted: n, sortIndexColumn: a, sortColumn: i, sortAscending: s }, l] = j({
            sorted: !1,
            sortIndexColumn: !1,
            sortColumn: void 0,
            sortAscending: !1,
        ...
        switch (t.nodeType) {
          case Node.ELEMENT_NODE:
            return o.createElement(
              ...
              !r && o.createElement(Qe, { tagName: t.tagName, styles: n.htmlCloseTag }),
            );
          case Node.TEXT_NODE:
      ...
      wr = (e) => o.createElement(ot, { nodeRenderer: Cr, dataIterator: Nr, ...e }),
      xr = de(wr),
      Lr = er(nr()),
      ...
      lt = Se(({ children: e, className: t }, r) =>
        o.createElement(Le, { ref: r, horizontal: !0, vertical: !0, className: t }, e),
      );
    lt.displayName = 'UnstyledWrapped';
    var Br = B(lt)({ margin: 0, padding: '10px 5px 20px' }),
      Fr = He(({ theme: e, ...t }) =>
        o.createElement(Ir, { theme: e.addonActionsTheme || 'chromeLight', table: !1, ...t }),
      ),
      Hr = ({ actions: e, onClear: t }) => {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(we, { actionItems: [{ title: 'Clear', onClick: t }] }),
          )
        );
      },
      zr = (e, t) => {
          ...
          (super(e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                ...
                return (
                  a && zr(a.data, t.data) ? a.count++ : ((t.count = 1), n.push(t)),
