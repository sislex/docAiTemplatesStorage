try {
  (() => {
    ...
    var It = __STORYBOOK_COMPONENTS__,
      {
        A: Et,
        ActionBar: xt,
        AddonPanel: gt,
    ...
    var U = { type: 'item', value: '' },
      ...
      z = (r) => (t) => {
        ...
        return (
          g(() => {
            a &&
              q(c, e, {
                next: { ...a.next, action: f },
                previous: { ...a.previous, action: I },
      ...
      J = ({ active: r, disabled: t, title: e, icon: o, description: a, onClick: c }) =>
        n.createElement(
          ...
          o && n.createElement(R, { icon: o, __suppressDeprecationWarning: !0 }),
          e ? `\xA0${e}` : null,
        ),
      Q = ({
        right: r,
          ...
          return n.createElement(
            H,
            {
              ...
              tooltip: ({ onHide: x }) => {
                ...
                return n.createElement(w, { links: G });
              },
